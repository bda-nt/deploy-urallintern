...
def enumerate_env():
    """
    Return a path for the ${pwd}/.env1 file.
...
@click.option('-f', '--file', default=enumerate_env(),
              ...
              help="Location of the .env1 file, defaults to .env1 file in current working directory.")
...
def cli(ctx: click.Context, file: Any, quote: Any, export: Any) -> None:
    """This script is used to set, get or unset values from a .env1 file."""
...
@click.option(
    ...
    default=True,
    help="Override variables from the environment file with those from the .env1 file.",
)
